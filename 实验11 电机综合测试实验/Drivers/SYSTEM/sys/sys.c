 ...
 */
  ...
  *
 *              外部晶振 25MHz: plln=336, pllm=25, pllp=2, pllq=7（须与 stm32f4xx_hal_conf.h 中 HSE_VALUE 一致）
 *              Fs/pllm=1MHz 进 PLL；Fvco = 25M*(336/25)=336MHz；Fsys=336/2=168MHz；Fq=336/7=48MHz(USB)
 *              若用 8MHz 晶振: pllm=8,其余同上；并改 HSE_VALUE 为 8000000
  *
